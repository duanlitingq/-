...
public class QRCodeUtil {
    ...
    public static void encode(String content, int width, int height,
        ...
        try {
            File targetFile = new File(destImagePath);
    ...
    public static void main(String[] args) {
        QRCodeUtil
                .encode("http://jq.zmjzc.cn/jsp/phone/jqzc/payment/wecharPaymentFromQr.jsp?vehicleId=250",
                        400, 400, "E:\\2013.jpg", "E:\\2013-01.jpg");
    }
}
